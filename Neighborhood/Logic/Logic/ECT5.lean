...
theorem LogicECT5.ssubset_LogicECTB : @LogicECTB ℕ ⊂ LogicECT5 := by
...
theorem LogicECT5.ssubset_LogicECB4 : @LogicECB4 ℕ ⊂ LogicECT5 := by
  apply Set.ssubset_iff_exists.mpr
  constructor
  · apply Hilbert.subset_of_provable_axioms
    rintro _ ((⟨_, _, rfl⟩ | ⟨_, rfl⟩) | ⟨_, rfl⟩)
...
theorem LogicECT5.ssubset_LogicET5 : @LogicET5 ℕ ⊂ LogicECT5 := by
  apply Set.ssubset_iff_exists.mpr
  constructor
