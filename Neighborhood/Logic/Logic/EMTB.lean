...
theorem LogicEMTB.ssubset_LogicEMDB : @LogicEMDB ℕ ⊂ LogicEMTB := by
...
theorem LogicEMTB.ssubset_LogicEMCNT : @LogicEMCNT ℕ ⊂ LogicEMTB := by
  apply Set.ssubset_iff_exists.mpr
  constructor
  · apply Hilbert.subset_of_provable_axioms
...
theorem LogicEMTB.ssubset_LogicECTB : @LogicECTB ℕ ⊂ LogicEMTB := by
  apply Set.ssubset_iff_exists.mpr
  constructor
