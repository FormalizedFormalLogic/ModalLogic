...
theorem LogicEM5.consistent : (@LogicEM5 α).IsConsistent := by
  by_contra! hC
  simpa using LogicEM5.sound frame_1_2 hC

instance : Nonempty (MaximalConsistentSet (@LogicEM5 α)) :=
  MaximalConsistentSet.nonempty LogicEM5.consistent
